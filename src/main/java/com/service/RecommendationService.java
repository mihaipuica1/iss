...
public class RecommendationService {
    ...
    public Recommendation addRecommendation(Recommendation recommendation) {
        ...
        Optional<PaperEntity> proposalEntity = paperRepository.findById(recommendation.getProposalId());

        RecommendationEntity entity = RecommendationMapper.recommendationToEntity(recommendation);
        entity.setPaper(proposalEntity.orElseThrow(() -> new HttpClientErrorException(HttpStatus.NOT_FOUND, "Paper not found.")));
